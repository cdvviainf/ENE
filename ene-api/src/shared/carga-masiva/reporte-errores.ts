...
// Portado de FAS. Genera un Excel con todos los errores detectados, listos
// para devolver al cliente: una hoja "Resumen" (conteo por hoja) y una hoja
// "Errores" (detalle fila por fila, ubicable en el archivo original).
