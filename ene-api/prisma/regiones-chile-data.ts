// Portado de FAS (fas-api/prisma/regiones-chile-data.ts). Generado a partir de
// 'Códigos Únicos Territoriales, vigentes a partir del 6 de septiembre de
// 2018' — Ministerio del Interior, Subsecretaría de Desarrollo Regional y
// Administrativo (SUBDERE). 16 regiones, 56 provincias, 346 comunas.
// codigo de Región: abreviación romana estándar (I..XII, XIV..XVI, RM).
// codigo de Provincia/Comuna: Código Único Territorial (INE).
